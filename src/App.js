...
const tld = ".ninja";
const CONTRACT_ADDRESS = "0xBd47ce8beC83Da057c81E354D593C777F36229E9";
...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
    ...
    const networkTemp = networks[chainId];
    setNetwork(networkTemp);
          ...
          <header>
            ...
            <div className="right">
              <img
                ...
                className="logo"
                src={
                  typeof network != "undefined" && network.includes("Polygon")
                    ? polygonLogo
                    : ethLogo
                }
              />
